...
Именно благодаря им программисты и могут выстроить требуемую последовательность действия, требуемую логику. Функция – это единица работы, скажем – нажал пользователь на кнопку, значит в этот момент должен произойти вызов функции, а следовательно и начаться последовательность действий, которая приведёт к требуемому результату.
...
Звучит сложно? На самом деле всё просто. `SwiftUI`позволяет вам описывать, как должно выглядеть ваше приложение, а система сама заботится о деталях реализации.
...
## 🛠️ `Xcode` — ваша главная рабочая среда
...
### Как начать работать в `Xcode`?

Если у вас `Mac`, скачайте `Xcode` бесплатно из [`Mac App Store`](https://apps.apple.com/ru/app/xcode/id497799835?mt=12%20Xcode).
